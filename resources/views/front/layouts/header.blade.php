<header
    ...
    <div class="flex items-center gap-3">
        ...
        <a href="{{ route(Route::currentRouteName(), array_merge($params, ['locale' => $switchLocale])) }}"
            class=" flex items-center gap-2 rounded-lg h-10 px-3 bg-slate-100 text-slate-700 text-xs font-bold border
            border-slate-200">

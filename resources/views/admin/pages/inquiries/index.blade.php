...
@section('page-header')
    <h2 class="text-lg font-bold text-primary">Pertanyaan</h2>
@endsection
@section('content')
    <div x-data="InquiriesTable()" x-init="init()" class="flex-1 overflow-y-auto p-8">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
            <div>
                <h1 class="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Pertanyaan</h1>
...
@endsection
{{-- @include('admin.pages.inquiries._form') --}}
<script>

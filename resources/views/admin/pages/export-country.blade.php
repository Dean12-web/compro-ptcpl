...
@section('content')
    ...
    <div class="flex-1 overflow-y-auto p-8">
            ...
            <div class="flex flex-col lg:flex-row gap-4">
                <div class="flex-1 relative">
                    ...
                    <input
                        ...
                        placeholder="Search by country name or code..." type="text" />
                </div>
                <div class="flex flex-wrap gap-2">
                    <div class="relative">
                        <select
                            class="appearance-none pl-4 pr-10 py-2 border border-primary/10 rounded-lg bg-background-light/30 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20">
                        ...
                        <span
                            class="material-symbols-outlined absolute right-2 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none">expand_more</span>
                    </div>
                    <div class="relative">
                        <select
                            class="appearance-none pl-4 pr-10 py-2 border border-primary/10 rounded-lg bg-background-light/30 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20">
                    ...
                    <button
                        class="flex items-center gap-2 px-4 py-2 border border-primary/20 text-primary font-bold rounded-lg hover:bg-primary/5 transition-all text-sm">
        ...
        <div class="bg-white dark:bg-background-dark border border-primary/10 rounded-xl shadow-sm overflow-hidden">
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-primary/[0.03] border-b border-primary/10">
                        <th class="px-6 py-4 text-xs font-bold text-primary uppercase tracking-wider">Country
                            Name</th>
                        <th class="px-6 py-4 text-xs font-bold text-primary uppercase tracking-wider">Region
                        </th>
                        <th class="px-6 py-4 text-xs font-bold text-primary uppercase tracking-wider">Shipping
                            Methods</th>
                        <th class="px-6 py-4 text-xs font-bold text-primary uppercase tracking-wider">Avg. Lead
                            Time</th>
                        <th class="px-6 py-4 text-xs font-bold text-primary uppercase tracking-wider">Active
                            Status</th>
                        <th class="px-6 py-4 text-xs font-bold text-primary uppercase tracking-wider text-right">
                            Actions</th>
                    </tr>
                </thead>
            ...
            <!-- Pagination -->
            <div class="px-6 py-4 border-t border-primary/10 flex items-center justify-between bg-background-light/30">
                <p class="text-sm text-slate-500">Showing <span class="font-bold text-slate-900">1</span> to
                    <span class="font-bold text-slate-900">4</span> of <span class="font-bold text-slate-900">24</span>
                    results
                </p>
                <div class="flex items-center gap-1">
                    ...
                    <button
                        class="size-8 flex items-center justify-center rounded hover:bg-primary/5 text-slate-600 font-medium text-sm">2</button>
                    <button
                        class="size-8 flex items-center justify-center rounded hover:bg-primary/5 text-slate-600 font-medium text-sm">3</button>
                    <button
                        class="size-8 flex items-center justify-center rounded border border-primary/10 hover:bg-primary/5 text-slate-400 transition-colors">
